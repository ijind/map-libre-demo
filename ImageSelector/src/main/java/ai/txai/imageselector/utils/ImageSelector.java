...
import ai.txai.imageselector.ImageSelectorActivity;
...
public class ImageSelector {
    ...
    public static final String SELECT_FOLDER_RESULT = "select_folder_result";

    public static final String SELECT_FOLDER_NAME = "select_folder_name";
    ...
    public static class ImageSelectorBuilder {
        ...
        public void start(Activity activity, int requestCode) {
            ...
            openImageSelectorActivity(activity, requestCode, config);
        }
        ...
        public void start(Fragment fragment, int requestCode) {
            ...
            openImageSelectorActivity(fragment, requestCode, config);
        }
         ...
         * @param config
         */
        private void openImageSelectorActivity(android.app.Fragment fragment, int requestCode, RequestConfig config) {
         ...
         * @param config
         */
        private void openImageSelectorActivity(Activity activity, int requestCode, RequestConfig config) {
         ...
         * @param config
         */
        private void openImageSelectorActivity(Fragment fragment, int requestCode, RequestConfig config) {
            Intent intent = new Intent(fragment.getActivity(), ImageSelectorActivity.class);
            intent.putExtra(ImageSelector.KEY_CONFIG, config);
            fragment.startActivityForResult(intent, requestCode);
        }
