package ai.txai.commonview.leftslidelib;
...
public class LeftSlideView extends LinearLayout {
	...
	private void init() {
		...
		mRightCanSlide = SizeUtils.dp2px(mDelLength);
	...
	private void upAnim() {
		...
		if (scrollX == mRightCanSlide || scrollX == 0) {
			...
			showDelete = scrollX == mRightCanSlide;
			if (mStatusChangeLister != null) {
				mStatusChangeLister.onStatusChange(showDelete);
			}
