...
*/
public class KeyValueDao extends AbstractDao<KeyValue, String> {
    ...
    @Override
    protected final String updateKeyAfterInsert(KeyValue entity, long rowId) {
        return entity.getKey();
    }
    
    @Override
    public String getKey(KeyValue entity) {
        if(entity != null) {
            return entity.getKey();
        } else {
            return null;
